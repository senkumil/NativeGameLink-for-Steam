...
export const SPANISH_TRANSLATIONS: Record<string, string> = {
	...
	playtime_tracking_properties_desc: 'Registra y muestra las horas jugadas en este juego si tu cliente de Steam no incluye seguimiento nativo.',
	...
	enable_big_picture_toggle: 'Activar interfaz mejorada de Big Picture',
	enable_big_picture_description: 'Muestra logros, cromos, insignias y centro de la comunidad en Big Picture. Desactivado por defecto para garantizar estabilidad nativa.',
