...
export function ensureActivityStyles(doc: Document): void {
	...
	injectLibraryStyle(doc, 'gdl-activity-styles', `
		...
		#gdl-activity-feed { font-family:"Motiva Sans",Arial,Helvetica,sans-serif; }
		.gdl-activity-container .${event.AppActivityDate},
		#gdl-activity-feed .${event.AppActivityDate} { font-family:"Motiva Sans",Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;color:#8f98a0;letter-spacing:1px;text-transform:uppercase;display:flex;align-items:center;gap:12px;margin:0 0 8px; }
		.gdl-activity-container .${event.Rule},
		#gdl-activity-feed .${event.Rule} { flex:1;height:1px;background:rgba(255,255,255,.08); }
		.gdl-activity-container .${event.PartnerEventLargeUpdate} .${event.PartnerEventType},
		#gdl-activity-feed .${event.PartnerEventLargeUpdate} .${event.PartnerEventType} { color:#1a9fff; }
		.gdl-activity-container .${event.PartnerEventLargeUpdate} .${event.PartnerEventLargeImage_Container},
		#gdl-activity-feed .${event.PartnerEventLargeUpdate} .${event.PartnerEventLargeImage_Container} { background:radial-gradient(100% 85% at 70% 95%,rgba(70,93,112,.30) 0%,rgba(41,57,71,.68) 32%,rgba(24,31,39,.88) 100%); }
		.gdl-activity-container .${event.PartnerEventLargeUpdate} .${event.PartnerEventLargeImage_Container}:hover,
		#gdl-activity-feed .${event.PartnerEventLargeUpdate} .${event.PartnerEventLargeImage_Container}:hover { background:radial-gradient(100% 85% at 70% 95%,rgba(108,139,174,.30) 0%,rgba(48,79,108,.56) 35%,rgba(22,47,70,.72) 100%); }
		...
		#gdl-activity-feed .${event.LeftSideMajorUpdateBar} { position:absolute;left:0;top:0;bottom:0;width:4px;background:#1a9fff;z-index:2;transition:background .15s ease-out,box-shadow .15s ease-out; }
		.gdl-activity-container .${event.PartnerEventMediumImage_Contents},
		#gdl-activity-feed .${event.PartnerEventMediumImage_Contents} { display:flex;flex-direction:row;align-items:stretch;min-height:120px;cursor:pointer; }
		.gdl-activity-container .${event.MediumImageContainer},
		#gdl-activity-feed .${event.MediumImageContainer} { flex:0 0 42%;max-width:320px;min-width:180px;aspect-ratio:16/9;overflow:hidden;position:relative; }
		.gdl-activity-container .${event.PartnerEventMediumImage_Image},
		#gdl-activity-feed .${event.PartnerEventMediumImage_Image} { width:100%;height:100%;object-fit:cover;display:block; }
		.gdl-activity-container .${event.PartnerEventMediumImage_TextColumn},
		#gdl-activity-feed .${event.PartnerEventMediumImage_TextColumn} { flex:1 1 auto;padding:12px 16px;display:flex;flex-direction:column;justify-content:flex-start;min-width:0;overflow:hidden; }
		.gdl-activity-container .${event.PartnerEventType},
		#gdl-activity-feed .${event.PartnerEventType} { font-size:11px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:#1a9fff;margin-bottom:4px; }
		.gdl-activity-container .${event.PartnerEventMediumImage_Title},
		#gdl-activity-feed .${event.PartnerEventMediumImage_Title} { font-size:16px;font-weight:600;color:#e5e5e5;line-height:1.3;margin-bottom:6px;overflow:hidden;text-overflow:ellipsis; }
		.gdl-activity-container .${event.PartnerEventMediumImage_Summary},
		#gdl-activity-feed .${event.PartnerEventMediumImage_Summary} { font-size:13px;color:#8f98a0;line-height:1.45;overflow:hidden;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical; }
		...
		.gdl-activity-container { display:flex;flex-direction:column;justify-content:flex-start;align-items:stretch;flex:none;height:auto;min-height:0;overflow:visible; }
