export const SPANISH_TOKEN_FALLBACKS: Record<string, string> = {
	...
	AppDetails_SectionTitle_Controller: 'MANDOS',
	...
	AppDetailsControllerSection_Title_Unsupported: 'No compatible con controles',
	AppDetailsControllerSection_NoSupport: 'El juego no fue diseñado para ser compatible con controles.',
	AppDetailsControllerSection_Title_Unknown: 'Compatibilidad con control desconocida',
	AppDetailsControllerSection_Unknown: 'Este juego aún no ha proporcionado nueva información de compatibilidad con controles y se desconoce su compatibilidad con tu dispositivo.',
	AppDetailsControllerSection_Title_Playable: 'Jugable',
	AppDetailsControllerSection_SteamInput: 'Steam Input está habilitado para este dispositivo.',
	AppDetailsControllerSection_SteamInputTranslation: 'Steam Input traduce las entradas de tu control para este juego.',
	AppControllerConfiguration_Link: 'Configuración del control',
